        ...
        <div class="content-login">
            <div class="content-login-info">
                ...
                <el-form ref="loginForm">
                    <el-form-item style="margin:25px 0px" :rules="[{ required: true, message: '请填写用户名' }]">
                        <el-input v-model="username" aria-label="用户名" placeholder="用户名" size="large"  />
                    </el-form-item>
                    <el-form-item  :rules="[{ required: true, message: '请填写密码' }]">
                        <el-input v-model="password" aria-label="密码" placeholder="密码" size="large"  />
                    </el-form-item>
                    <el-form-item>
